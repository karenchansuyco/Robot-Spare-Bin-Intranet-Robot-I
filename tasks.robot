...
Download The Excel File
    Download    https://robotsparebinindustries.com/SalesData.xlsx    target_file=${CURDIR}${/}output${/}SalesData.xlsx    overwrite=True
...
Fill The Form Using The Data From The Excel File
    Open Workbook    ${CURDIR}${/}output${/}SalesData.xlsx
